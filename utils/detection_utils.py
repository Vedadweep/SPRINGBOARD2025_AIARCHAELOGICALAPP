import cv2
import numpy as np
# from ultralytics import YOLO          # moved into load_model
from PIL import Image
# import torch                          # moved into load_model
...
class DetectionManager:
    def __init__(self):
        self.model_path = "C:\\Users\\Vedadweep\\Downloads\\ai_app\\ai_app\\best.pt"
        self.model = None
    ...
    def load_model(self):
        """Load the YOLO model, importing heavy deps lazily and reporting errors"""
        try:
